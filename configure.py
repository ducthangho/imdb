...
modes = {
    'debug': {
        ...
        'opt': '-O0 -DDEBUG -D_GLIBCXX_USE_CXX11_ABI=0 -DDEFAULT_ALLOCATOR -Dgtest_build_tests=ON -D__USE_KJ__',
        'libs': '-lcapnpc -lcapnp-rpc -lcapnp -lkj-async -lkj -luv',
    },
    'release': {
        'sanitize': '',
        'sanitize_libs': '',
        'opt': '-O2  -D_GLIBCXX_USE_CXX11_ABI=0 -D__USE_KJ__',
        'libs': '-lcapnpc -lcapnp-rpc -lcapnp -lkj-async -lkj -luv',
    },
}
...
defines = []
libs = '-laio -lboost_program_options -lboost_system -lstdc++ -lm -lboost_unit_test_framework -lboost_thread -lcapnpc -lcapnp-rpc -lcapnp -lkj-async -lkj -luv -lcryptopp -lrt'
...
deps = {
    ...
    'apps/imdb/imdb': ['apps/imdb/main.cc','apps/imdb/vmts-rpc.cc','apps/imdb/hashprotocol.capnp.cc'] + core +libnet,
